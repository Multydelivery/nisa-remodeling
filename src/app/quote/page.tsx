      ...
      <div className="flex flex-col lg:flex-row gap-12 w-full max-w-6xl animate-fade-in delay-200">
        ...
        <div className="flex-1">
          <div className="bg-black/40 rounded-xl p-8 border border-slate-700/20 shadow-lg h-full">
            <h2 className="text-2xl font-semibold mb-6 text-stone-200">Why Get a Quote?</h2>
            
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="bg-slate-300/6 p-3 rounded-lg mr-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-stone-300 mb-1">Transparent Pricing</h3>
                  <p className="text-stone-300/80">No hidden fees or surprises. We provide detailed breakdowns of all costs.</p>
                </div>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-slate-700/20">
              <h3 className="text-lg font-semibold text-stone-300 mb-4">What&apos;s Next?</h3>
              <ol className="space-y-3">
                <li className="flex items-start text-stone-300/90 text-sm">
                  <span className="bg-slate-300/10 text-stone-300 rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold mr-3">1</span>
                  Submit your quote request
                </li>
                <li className="flex items-start text-stone-300/90 text-sm">
                  <span className="bg-slate-300/10 text-stone-300 rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold mr-3">2</span>
                  We&apos;ll contact you to discuss details
                </li>
                <li className="flex items-start text-stone-300/90 text-sm">
                  <span className="bg-slate-300/10 text-stone-300 rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold mr-3">3</span>
                  Receive your personalized quote
                </li>
                <li className="flex items-start text-stone-300/90 text-sm">
                  <span className="bg-slate-300/10 text-stone-300 rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold mr-3">4</span>
        ...
        <div className="flex-1">
          <div className="bg-black/40 rounded-xl p-8 border border-slate-700/20 shadow-lg">
            <h2 className="text-2xl font-semibold mb-6 text-stone-200">Request Your Quote</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    className="w-full px-4 py-3 rounded-lg bg-gray-900 text-stone-200 border border-slate-700/30 focus:outline-none focus:ring-2 focus:ring-slate-300 transition-all placeholder:text-stone-300/40"
                    type="text"
                    id="name"
                    name="name"
                    value={formData.name}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <select
                    className="w-full px-4 py-3 rounded-lg bg-gray-900 text-stone-200 border border-slate-700/30 focus:outline-none focus:ring-2 focus:ring-slate-300 transition-all"
                    id="service"
                    name="service"
